...
- **[Agent Skills](/ui/docs/skills)** — Install creantly knowledge directly into your AI assistant with `npx skills add NessinM/creantly`. Covers all 53 primitives, styling conventions, migration patterns, and particle examples.
